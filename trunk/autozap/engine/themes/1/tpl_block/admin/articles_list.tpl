...
{foreach from=$articles->result item=arr}
  <tr class="tr_{cycle values='even,odd'}" id="table_borders" onmouseover="this.style.border = '1px solid #333333';" onmouseout="this.style.border = '0px'">
    <td class="td" width="70%">&nbsp;<a href="/admin/articles/{$arr.pk_article_id}/">{$arr.article_name}</a></td>
    <td class="td" width="10%">&nbsp;{$arr.article_timestamp|date_format}</td>
    <td class="td" width="10%">&nbsp;{$arr.users_name}</td>
    <td class="td" width="10%">&nbsp;<a href="/admin/articles/{$arr.pk_article_id}/edit/">edit</a></td>
  </tr>
{/foreach}
