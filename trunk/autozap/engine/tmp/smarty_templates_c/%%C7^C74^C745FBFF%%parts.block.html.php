<?php /* Smarty version 2.6.14, created on 2008-07-24 13:18:55
         compiled from parts.block.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'parts.block.html', 29, false),)), $this); ?>
<?php $this->assign('model_id', 0);  $this->assign('brand_id', 0); ?>
<table width="100%">
<?php $_from = $this->_tpl_vars['parts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
