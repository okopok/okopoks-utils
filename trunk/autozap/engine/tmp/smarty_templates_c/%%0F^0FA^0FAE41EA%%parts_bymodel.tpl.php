<?php /* Smarty version 2.6.14, created on 2008-08-05 16:04:17
         compiled from D:/HTDOCS/autozap.local/www/engine/themes/1/tpl_block/public/parts_bymodel.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'D:/HTDOCS/autozap.local/www/engine/themes/1/tpl_block/public/parts_bymodel.tpl', 22, false),)), $this); ?>
<table width="100%">
<?php $_from = $this->_tpl_vars['parts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['brands'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['brands']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['arr']):
        $this->_foreach['brands']['iteration']++;
 if (($this->_foreach['brands']['iteration'] <= 1)): ?>
  <tr class="brand_div">
    <td class="td" colspan="4">
      <?php if ($this->_tpl_vars['brandsImages'][$this->_tpl_vars['brand_id']]['small']): ?><img src="<?php echo $this->_tpl_vars['brandsImages'][$this->_tpl_vars['brand_id']]['small']; ?>
" align="right"/><?php endif; ?>
      <a href="/parts/<?php echo $this->_tpl_vars['brandsbyid'][$this->_tpl_vars['arr']['pk_brands_id']]['brands_name_tag']; ?>
/"><?php echo $this->_tpl_vars['brandsbyid'][$this->_tpl_vars['arr']['pk_brands_id']]['brands_name']; ?>
  ...
  <tr class="model_div">
    <td class="td" width="100%" colspan="4">
      <a href="/parts/<?php echo $this->_tpl_vars['modelsbyid'][$this->_tpl_vars['arr']['fk_models_id']]['brands_name_tag']; ?>
