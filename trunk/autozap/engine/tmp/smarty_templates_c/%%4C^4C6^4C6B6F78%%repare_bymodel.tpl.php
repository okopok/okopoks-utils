<?php /* Smarty version 2.6.14, created on 2008-08-05 16:39:51
         compiled from D:/HTDOCS/autozap.local/www/engine/themes/1/tpl_block/public/repare_bymodel.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'D:/HTDOCS/autozap.local/www/engine/themes/1/tpl_block/public/repare_bymodel.tpl', 22, false),)), $this); ?>
<table width="100%">
...
/"><?php echo $this->_tpl_vars['brandsbyid'][$this->_tpl_vars['arr']['pk_brands_id']]['brands_name']; ?>
  ...
  <tr class="model_div">
    <td class="td" width="100%" colspan="4">
      <a href="/repare/<?php echo $this->_tpl_vars['modelsbyid'][$this->_tpl_vars['arr']['fk_models_id']]['brands_name_tag']; ?>
...
" id="table_borders" onmouseover="this.style.border = '1px solid #333333';" onmouseout="this.style.border = '0px'">
    ...
    <td class="td" width="10%">&nbsp;<?php echo $this->_tpl_vars['arr']['repare_uid']; ?>
</td>
    <td class="td" width="10%">&nbsp;<?php echo $this->_tpl_vars['arr']['repare_cost']; ?>
</td>
    <td class="td" width="10%">&nbsp;<?php echo $this->_tpl_vars['arr']['repare_cost_old']; ?>
</td>
  </tr>
